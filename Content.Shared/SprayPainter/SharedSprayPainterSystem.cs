...
public abstract class SharedSprayPainterSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<SPaintedComponent, ExaminedEvent>(OnPainedExamined);
    ...
    private void OnPainterDoAfter(Entity<SprayPainterComponent> ent, ref SprayPainterDoAfterEvent args)
    {
        ...
        var spaintedComponent = EnsureComp<SPaintedComponent>(target);
        spaintedComponent.DryTime = _timing.CurTime + ent.Comp.FreshPaintDuration;
        Dirty(target, spaintedComponent);
    ...
    /// </summary>
    private void OnPainedExamined(Entity<SPaintedComponent> ent, ref ExaminedEvent args)
    {
